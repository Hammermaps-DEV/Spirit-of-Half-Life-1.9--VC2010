...
// Misc. Prototypes
extern void		UTIL_SetSize(CBaseEntity *pEntity, const Vector &vecMin, const Vector &vecMax);
extern void		UTIL_SetEdictSize(entvars_t *pEdict, const Vector &vecMin, const Vector &vecMax);
